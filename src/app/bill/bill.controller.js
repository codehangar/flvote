  ...
  function BillCtrl(TwitterSvc, BillsSvc, $stateParams) {
    ...
    vm.fetchBill = function () {
      ...
      BillsSvc.fetchBillByID(billId).then(function(d) {
        ...
        vm.bill.voteYesLink = 'https://twitter.com/home?status=I%20support%20%23'+hashIdentifier+
        ...
        vm.bill.voteNoLink = 'https://twitter.com/home?status=I%20don%E2%80%99t%20support%20%23'+hashIdentifier+
